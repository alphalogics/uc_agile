...
class _PodcastsScreenState extends State<PodcastsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((timeStamp) {
      Provider.of<ExclusiveViewModel>(context, listen: false).getMaterialDataResponse(StringConst.podcast_id, '8e176aeed07572c08f2522de1b502501');
    });
  }
