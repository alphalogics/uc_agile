...
class _MeetupsScreenState extends State<MeetupsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((timeStamp) {
      Provider.of<ExclusiveViewModel>(context, listen: false).getMaterialDataResponse(StringConst.meetups_id, '8e176aeed07572c08f2522de1b502501');
    });
  }
