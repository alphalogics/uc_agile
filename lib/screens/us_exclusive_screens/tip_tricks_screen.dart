...
class TipTricksScreen extends StatefulWidget {
  static const String id = "TipTricksScreen";

  @override
  State<TipTricksScreen> createState() => _TipTricksScreenState();
}

class _TipTricksScreenState extends State<TipTricksScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((timeStamp) {
      Provider.of<ExclusiveViewModel>(context, listen: false).getMaterialDataResponse(StringConst.tip_trick_id, '8e176aeed07572c08f2522de1b502501');
    });
  }
